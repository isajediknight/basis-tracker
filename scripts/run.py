...
result = first_api_call.getAccountTokensJSON('2g4joCYzR3QA3SDypr6SJWzgnQX5xUpBF463rvJJfw78')
...
watching = ['rBasis','basis','USD Coin']

for i in range(len(result)):
    if result[i]['tokenName'] in watching:
        print(result[i]['tokenName'] + ':' + str(int(result[i]['tokenAmount']['uiAmount'])))
